...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 15 2014 г., 12:20
...
(1, 'surname', 'Ivanov', 'text', 'required', '', 'Your last name'),
(2, 'name', 'Ivan', 'text', 'required', '', 'Your name'),
(5, 'adress', 'Polya str. 525', 'text', '', '', 'Post adress'),
...
(9, 'login', 'Dr.Watson', 'text', 'required', '', 'Your username'),
(10, 'pass', '********', 'password', 'required', '[\\W\\S]{8,20}', 'Enter password (>7 symbol)'),
(11, 'password_check', '********', 'password', 'required', '[\\W\\S]{8,20}', 'Enter the password again');
